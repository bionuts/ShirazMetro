...
public class MainActivity extends AppCompatActivity
    ...
    public void onButtonClicked(View view) {
        ...
        Intent intent = new Intent(getApplicationContext(), TilesActivity.class);
    ...
    public void onButton4Clicked(View view) {
        Intent intent = new Intent(getApplicationContext(), ContactUs2.class);
        startActivity(intent);
    }

    public void onButton5Clicked(View view) {
        Intent intent = new Intent(getApplicationContext(), SuggestFormActivity.class);
        startActivity(intent);
    }
    ...
    public void onButton7Clicked(View view) {
        Intent intent = new Intent(getApplicationContext(), AppImproveActivity.class);
        startActivity(intent);
    }
